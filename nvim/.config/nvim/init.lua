...
vim.keymap.set('n', '<Tab>', '<C-w>w', { desc = 'Focus next window' })
...
require('lazy').setup({
  ...
  { -- File browser
    ...
    cmd = 'Neotree',
    keys = {
      { '<C-n>', '<cmd>Neotree toggle current reveal_force_cwd<cr>', desc = 'NeoTree fullscreen' },
      { '<leader>n', '<cmd>Neotree toggle reveal_force_cwd<cr>', desc = 'NeoTree toggle' },
      { '<leader>b', '<cmd>Neotree toggle reveal buffers<cr>', desc = 'NeoTree buffers' },
    },
    opts = {
      filesystem = {
        filtered_items = {
